...
//  including complex and real matrices using the irreducible (p,p) degree
...
//  and p is internally set to 6 (recommended and generally satisfactory).
//
...
// H2 is not needed anymore, so it is temporarily used as identity matrix for substituting.
	H2.assign(I); 
